...
var EVENTS = [
  {
    date: "2026-08",
    label: "REALITY",
    title: "REALITY CON 2026 IN 幕張メッセ 入口案内アナウンス動画への出演が決定！",
    desc: "初めての公募形式での採用、本当にうれしかったです！この勢いに乗ってこれからも頑張っていきたいと思います！よろしくお願いします！"
  },
  {
    date:"2026-08",
    label: "REALITY",
    title: "初配信から9か月未満、ねこさんうさぎさんぬいぐるみ獲得イベント グループ4位",
    desc: "惜しくも入賞できず！でもよく頑張った！！"
  },  
  {
    date: "2026-05",          // 年月（表示用）
